...
export function Bronco(props) {
  ...
  return (
    <group {...props} dispose={null}>
      <mesh geometry={nodes.plate.geometry} material={materials.plate} position={[0, 1.337, 5.003]} rotation={[-1.566, 0, 0]} scale={[0.139, 0.225, 0.225]} />
      ...
      <mesh geometry={nodes.body016.geometry} material={materials.TopGun} position={[-0.01, 0.015, -0.044]} material-color={snap1.base.BaseMtl} visible={overlay === 17}/>
      <mesh geometry={nodes.body017.geometry} material={materials.Explosion} position={[-0.01, 0.015, -0.044]} material-color={snap1.base.BaseMtl} visible={overlay === 18}/>
      <mesh geometry={nodes.body018.geometry} material={materials.WildWest} position={[-0.01, 0.015, -0.044]} material-color={snap1.base.BaseMtl} visible={overlay === 19}/>
      <mesh geometry={nodes.body019.geometry} material={materials.Zombie} position={[-0.01, 0.015, -0.044]} material-color={snap1.base.BaseMtl} visible={overlay === 20}/>
      ...
      <mesh geometry={nodes.Object_4.geometry} material={materials.turn_light} />
      ...
      <mesh geometry={nodes.Object_5.geometry} material={materials.white_Light223} />
      ...
      <mesh geometry={nodes.Object_6.geometry} material={materials.white_Light223} />
      ...
      <mesh geometry={nodes.Object_7.geometry} material={materials['BaseMtl.001']} />
