      ...
      <group rotation={[-Math.PI / 2, 0, 0]} scale={0.005}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          <group position={[0, 89.972, 307.014]}>
            ...
            <mesh geometry={nodes.Body002.geometry} material={materials.Slaughter} material-color={snap1.base.BaseMtl} visible={overlay === 2}/>
            <mesh geometry={nodes.Body003.geometry} material={materials.BatLady} material-color={snap1.base.BaseMtl} visible={overlay === 3}/>
            <mesh geometry={nodes.Body004.geometry} material={materials.BrakeLine} material-color={snap1.base.BaseMtl} visible={overlay === 4}/>
            <mesh geometry={nodes.Body005.geometry} material={materials.Danger} material-color={snap1.base.BaseMtl} visible={overlay === 5}/>
            <mesh geometry={nodes.Body006.geometry} material={materials.Embers} material-color={snap1.base.BaseMtl} visible={overlay === 6}/>
            <mesh geometry={nodes.Body007.geometry} material={materials.SpiderID} material-color={snap1.base.BaseMtl} visible={overlay === 7}/>
            <mesh geometry={nodes.Body008.geometry} material={materials.Fluid} material-color={snap1.base.BaseMtl} visible={overlay === 8}/>
            <mesh geometry={nodes.Body009.geometry} material={materials.HotRods} material-color={snap1.base.BaseMtl} visible={overlay === 9}/>
            <mesh geometry={nodes.Body010.geometry} material={materials.Mayan} material-color={snap1.base.BaseMtl} visible={overlay === 10}/>
            <mesh geometry={nodes.Body011.geometry} material={materials.SeaBreeze} material-color={snap1.base.BaseMtl} visible={overlay === 11}/>
            <mesh geometry={nodes.Body012.geometry} material={materials.ShapeShifter} material-color={snap1.base.BaseMtl} visible={overlay === 12}/>
            <mesh geometry={nodes.Body013.geometry} material={materials.Silk} material-color={snap1.base.BaseMtl} visible={overlay === 13}/>
            <mesh geometry={nodes.Body014.geometry} material={materials.SnakeSkin} material-color={snap1.base.BaseMtl} visible={overlay === 14}/>
            <mesh geometry={nodes.Body015.geometry} material={materials.Flare} material-color={snap1.base.BaseMtl} visible={overlay === 15}/>
            <mesh geometry={nodes.Body016.geometry} material={materials.Dominator} material-color={snap1.base.BaseMtl} visible={overlay === 16}/>
            <mesh geometry={nodes.Body017.geometry} material={materials.TopGun} material-color={snap1.base.BaseMtl} visible={overlay === 17}/>
            <mesh geometry={nodes.Body018.geometry} material={materials.Explosion} material-color={snap1.base.BaseMtl} visible={overlay === 18}/>
            <mesh geometry={nodes.Body019.geometry} material={materials.WildWest} material-color={snap1.base.BaseMtl} visible={overlay === 19}/>
            <mesh geometry={nodes.Body020.geometry} material={materials.Zombie} material-color={snap1.base.BaseMtl} visible={overlay === 20}/>
